...
func (tpa *TestPromAPI) LabelNames(ctx context.Context) ([]string, error) {
...
func (tpa *TestPromAPI) Query(c context.Context, query string, ts time.Time) (model.Value, api.Warnings, error) {
...
func (tpa *TestPromAPI) QueryRange(ctx context.Context, query string, r v1.Range) (model.Value, api.Warnings, error) {
	s := model.Sample{Value: expected}
	var v []*model.Sample
	v = append(v, &s)
...
func (tpa *TestPromAPI) Series(ctx context.Context, matches []string, startTime time.Time, endTime time.Time) ([]model.LabelSet, api.Warnings, error) {
	return nil, nil, nil
}
...
func (t *TestPromAPI) Rules(ctx context.Context) (v1.RulesResult, error) {
...
func (t *TestPromAPI) TargetsMetadata(ctx context.Context, matchTarget string, metric string, limit string) ([]v1.MetricMetadata, error) {
	return nil, nil
}
