...
func (ca *CustomArgs) AddFlags(fs *pflag.FlagSet) {
	...
	fs.StringVar(&ca.ForceKinds, "force-kinds", ca.ForceKinds, `force kinds will override the genreconciler tag setting for the given set of kinds, comma separated: "Foo,Bar,Baz"`)
}
