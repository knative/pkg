...
var foosResource = schema.GroupVersionResource{Group: "sample.knative.dev", Version: "v1alpha1", Resource: "foos"}

var foosKind = schema.GroupVersionKind{Group: "sample.knative.dev", Version: "v1alpha1", Kind: "Foo"}
