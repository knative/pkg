...
// NewController creates a Reconciler for Foo and returns the result of NewImpl.
func NewController(
	ctx context.Context,
	...
	fooInformer := foo.Get(ctx)

	// TODO: setup additional informers here.

	r := &Reconciler{}
	impl := v1alpha1foo.NewImpl(ctx, r)

	logger.Info("Setting up event handlers.")

	fooInformer.Informer().AddEventHandler(controller.HandleAll(impl.Enqueue))
