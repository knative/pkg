...
import (
	...
	externalversions "knative.dev/pkg/client/test/informers/externalversions"
	client "knative.dev/pkg/client/test/injection/client"
...
func Get(ctx context.Context) externalversions.SharedInformerFactory {
	...
	if untyped == nil {
		logging.FromContext(ctx).Panic(
			"Unable to fetch knative.dev/pkg/client/test/informers/externalversions.SharedInformerFactory from context.")
	}
