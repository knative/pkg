...
import (
	...
	pubv1alpha1 "knative.dev/pkg/apis/test/pub/v1alpha1"
	versioned "knative.dev/pkg/client/test/pub/clientset/versioned"
	internalinterfaces "knative.dev/pkg/client/test/pub/informers/externalversions/internalinterfaces"
	v1alpha1 "knative.dev/pkg/client/test/pub/listers/pub/v1alpha1"
)
...
func (f *barInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&pubv1alpha1.Bar{}, f.defaultInformer)
}
