...
import (
	...
	externalversions "knative.dev/pkg/client/test/pub/informers/externalversions"
	client "knative.dev/pkg/client/test/pub/injection/client"
...
func Get(ctx context.Context) externalversions.SharedInformerFactory {
	...
	if untyped == nil {
		logging.FromContext(ctx).Panic(
			"Unable to fetch knative.dev/pkg/client/test/pub/informers/externalversions.SharedInformerFactory from context.")
	}
