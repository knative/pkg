...
import (
	...
	versionedscheme "knative.dev/pkg/client/test/pub/clientset/versioned/scheme"
	injectionclient "knative.dev/pkg/client/test/pub/injection/client"
...
const (
	defaultControllerAgentName = "bar-controller"
	defaultFinalizerName       = "bars.sample.knative.dev"
	defaultQueueName           = "bars"
)
