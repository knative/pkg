...
import (
	...
	examplev1alpha1 "knative.dev/pkg/apis/test/example/v1alpha1"
	...
	v1alpha1 "knative.dev/pkg/client/test/listers/example/v1alpha1"
)
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.SampleV1alpha1().Foos(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.SampleV1alpha1().Foos(namespace).Watch(options)
			},
		},
		&examplev1alpha1.Foo{},
		resyncPeriod,
...
func (f *fooInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&examplev1alpha1.Foo{}, f.defaultInformer)
}
