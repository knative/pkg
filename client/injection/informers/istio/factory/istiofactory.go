...
func withInformerFactory(ctx context.Context, resyncPeriod time.Duration) context.Context {
	sc := istio.Get(ctx)
	return context.WithValue(ctx, key{}, externalversions.NewSharedInformerFactory(sc, resyncPeriod))
}
