...
import (
	...
	autoscaling "github.com/knative/pkg/client/injection/clients/autoscaling"
...
func withInformerFactory(ctx context.Context) context.Context {
	c := autoscaling.Get(ctx)
	return context.WithValue(ctx, Key{},
		informers.NewSharedInformerFactory(c, controller.GetResyncPeriod(ctx)))
}
