...
func (w *wrapClient) ResourceV1alpha1() typedresourcev1alpha1.ResourceV1alpha1Interface {
	return &wrapResourceV1alpha1{
		dyn: w.dyn,
	}
}

type wrapResourceV1alpha1 struct {
	dyn dynamic.Interface
}

func (w *wrapResourceV1alpha1) RESTClient() rest.Interface {
	panic("RESTClient called on dynamic client!")
}

func (w *wrapResourceV1alpha1) PodSchedulings(namespace string) typedresourcev1alpha1.PodSchedulingInterface {
	return &wrapResourceV1alpha1PodSchedulingImpl{
		dyn: w.dyn.Resource(schema.GroupVersionResource{
...
type wrapResourceV1alpha1PodSchedulingImpl struct {
	dyn dynamic.NamespaceableResourceInterface

	namespace string
}

var _ typedresourcev1alpha1.PodSchedulingInterface = (*wrapResourceV1alpha1PodSchedulingImpl)(nil)

func (w *wrapResourceV1alpha1PodSchedulingImpl) Apply(ctx context.Context, in *resourcev1alpha1.PodSchedulingApplyConfiguration, opts metav1.ApplyOptions) (result *apiresourcev1alpha1.PodScheduling, err error) {
	in.Kind = ptr.String("PodScheduling")

	in.APIVersion = ptr.String("resource.k8s.io/v1alpha1")
	...
	out := &apiresourcev1alpha1.PodScheduling{}
	if err := convert(uo, out); err != nil {
		return nil, err
	}
	return out, nil
...
func (w *wrapResourceV1alpha1PodSchedulingImpl) ApplyStatus(ctx context.Context, in *resourcev1alpha1.PodSchedulingApplyConfiguration, opts metav1.ApplyOptions) (result *apiresourcev1alpha1.PodScheduling, err error) {
	in.Kind = ptr.String("PodScheduling")
...
func (w *wrapResourceV1alpha1PodSchedulingImpl) Create(ctx context.Context, in *apiresourcev1alpha1.PodScheduling, opts metav1.CreateOptions) (*apiresourcev1alpha1.PodScheduling, error) {
	in.SetGroupVersionKind(schema.GroupVersionKind{
		Group:   "resource.k8s.io",
		Version: "v1alpha1",
		Kind:    "PodScheduling",
...
func (w *wrapResourceV1alpha1PodSchedulingImpl) Delete(ctx context.Context, name string, opts metav1.DeleteOptions) error {
	return w.dyn.Namespace(w.namespace).Delete(ctx, name, opts)
}

func (w *wrapResourceV1alpha1PodSchedulingImpl) DeleteCollection(ctx context.Context, opts metav1.DeleteOptions, listOpts metav1.ListOptions) error {
	return w.dyn.Namespace(w.namespace).DeleteCollection(ctx, opts, listOpts)
}

func (w *wrapResourceV1alpha1PodSchedulingImpl) Get(ctx context.Context, name string, opts metav1.GetOptions) (*apiresourcev1alpha1.PodScheduling, error) {
	uo, err := w.dyn.Namespace(w.namespace).Get(ctx, name, opts)
	if err != nil {
		return nil, err
	}
...
func (w *wrapResourceV1alpha1PodSchedulingImpl) List(ctx context.Context, opts metav1.ListOptions) (*apiresourcev1alpha1.PodSchedulingList, error) {
	uo, err := w.dyn.Namespace(w.namespace).List(ctx, opts)
	if err != nil {
		return nil, err
	}
	out := &apiresourcev1alpha1.PodSchedulingList{}
	if err := convert(uo, out); err != nil {
		return nil, err
	}
	return out, nil
...
func (w *wrapResourceV1alpha1PodSchedulingImpl) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts metav1.PatchOptions, subresources ...string) (result *apiresourcev1alpha1.PodScheduling, err error) {
	uo, err := w.dyn.Namespace(w.namespace).Patch(ctx, name, pt, data, opts)
	if err != nil {
		return nil, err
	}
...
func (w *wrapResourceV1alpha1PodSchedulingImpl) Update(ctx context.Context, in *apiresourcev1alpha1.PodScheduling, opts metav1.UpdateOptions) (*apiresourcev1alpha1.PodScheduling, error) {
	in.SetGroupVersionKind(schema.GroupVersionKind{
		Group:   "resource.k8s.io",
		Version: "v1alpha1",
		Kind:    "PodScheduling",
...
func (w *wrapResourceV1alpha1PodSchedulingImpl) UpdateStatus(ctx context.Context, in *apiresourcev1alpha1.PodScheduling, opts metav1.UpdateOptions) (*apiresourcev1alpha1.PodScheduling, error) {
	in.SetGroupVersionKind(schema.GroupVersionKind{
		Group:   "resource.k8s.io",
		Version: "v1alpha1",
		Kind:    "PodScheduling",
...
func (w *wrapResourceV1alpha1PodSchedulingImpl) Watch(ctx context.Context, opts metav1.ListOptions) (watch.Interface, error) {
	return nil, errors.New("NYI: Watch")
}

func (w *wrapResourceV1alpha1) ResourceClaims(namespace string) typedresourcev1alpha1.ResourceClaimInterface {
	return &wrapResourceV1alpha1ResourceClaimImpl{
		dyn: w.dyn.Resource(schema.GroupVersionResource{
			Group:    "resource.k8s.io",
			Version:  "v1alpha1",
...
type wrapResourceV1alpha1ResourceClaimImpl struct {
	dyn dynamic.NamespaceableResourceInterface

	namespace string
}

var _ typedresourcev1alpha1.ResourceClaimInterface = (*wrapResourceV1alpha1ResourceClaimImpl)(nil)

func (w *wrapResourceV1alpha1ResourceClaimImpl) Apply(ctx context.Context, in *resourcev1alpha1.ResourceClaimApplyConfiguration, opts metav1.ApplyOptions) (result *apiresourcev1alpha1.ResourceClaim, err error) {
	...
	out := &apiresourcev1alpha1.ResourceClaim{}
	if err := convert(uo, out); err != nil {
		return nil, err
	}
	return out, nil
...
func (w *wrapResourceV1alpha1ResourceClaimImpl) ApplyStatus(ctx context.Context, in *resourcev1alpha1.ResourceClaimApplyConfiguration, opts metav1.ApplyOptions) (result *apiresourcev1alpha1.ResourceClaim, err error) {
	in.Kind = ptr.String("ResourceClaim")
...
func (w *wrapResourceV1alpha1ResourceClaimImpl) Create(ctx context.Context, in *apiresourcev1alpha1.ResourceClaim, opts metav1.CreateOptions) (*apiresourcev1alpha1.ResourceClaim, error) {
	in.SetGroupVersionKind(schema.GroupVersionKind{
		Group:   "resource.k8s.io",
		Version: "v1alpha1",
		Kind:    "ResourceClaim",
...
func (w *wrapResourceV1alpha1ResourceClaimImpl) Delete(ctx context.Context, name string, opts metav1.DeleteOptions) error {
	return w.dyn.Namespace(w.namespace).Delete(ctx, name, opts)
}

func (w *wrapResourceV1alpha1ResourceClaimImpl) DeleteCollection(ctx context.Context, opts metav1.DeleteOptions, listOpts metav1.ListOptions) error {
	return w.dyn.Namespace(w.namespace).DeleteCollection(ctx, opts, listOpts)
}

func (w *wrapResourceV1alpha1ResourceClaimImpl) Get(ctx context.Context, name string, opts metav1.GetOptions) (*apiresourcev1alpha1.ResourceClaim, error) {
	uo, err := w.dyn.Namespace(w.namespace).Get(ctx, name, opts)
	if err != nil {
		return nil, err
	}
...
func (w *wrapResourceV1alpha1ResourceClaimImpl) List(ctx context.Context, opts metav1.ListOptions) (*apiresourcev1alpha1.ResourceClaimList, error) {
	uo, err := w.dyn.Namespace(w.namespace).List(ctx, opts)
	if err != nil {
		return nil, err
	}
	out := &apiresourcev1alpha1.ResourceClaimList{}
	if err := convert(uo, out); err != nil {
		return nil, err
	}
	return out, nil
...
func (w *wrapResourceV1alpha1ResourceClaimImpl) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts metav1.PatchOptions, subresources ...string) (result *apiresourcev1alpha1.ResourceClaim, err error) {
	uo, err := w.dyn.Namespace(w.namespace).Patch(ctx, name, pt, data, opts)
	if err != nil {
		return nil, err
	}
...
func (w *wrapResourceV1alpha1ResourceClaimImpl) Update(ctx context.Context, in *apiresourcev1alpha1.ResourceClaim, opts metav1.UpdateOptions) (*apiresourcev1alpha1.ResourceClaim, error) {
	in.SetGroupVersionKind(schema.GroupVersionKind{
		Group:   "resource.k8s.io",
		Version: "v1alpha1",
		Kind:    "ResourceClaim",
...
func (w *wrapResourceV1alpha1ResourceClaimImpl) UpdateStatus(ctx context.Context, in *apiresourcev1alpha1.ResourceClaim, opts metav1.UpdateOptions) (*apiresourcev1alpha1.ResourceClaim, error) {
	in.SetGroupVersionKind(schema.GroupVersionKind{
		Group:   "resource.k8s.io",
		Version: "v1alpha1",
		Kind:    "ResourceClaim",
...
func (w *wrapResourceV1alpha1ResourceClaimImpl) Watch(ctx context.Context, opts metav1.ListOptions) (watch.Interface, error) {
	return nil, errors.New("NYI: Watch")
}

func (w *wrapResourceV1alpha1) ResourceClaimTemplates(namespace string) typedresourcev1alpha1.ResourceClaimTemplateInterface {
	return &wrapResourceV1alpha1ResourceClaimTemplateImpl{
		dyn: w.dyn.Resource(schema.GroupVersionResource{
			Group:    "resource.k8s.io",
			Version:  "v1alpha1",
...
type wrapResourceV1alpha1ResourceClaimTemplateImpl struct {
	dyn dynamic.NamespaceableResourceInterface

	namespace string
}

var _ typedresourcev1alpha1.ResourceClaimTemplateInterface = (*wrapResourceV1alpha1ResourceClaimTemplateImpl)(nil)

func (w *wrapResourceV1alpha1ResourceClaimTemplateImpl) Apply(ctx context.Context, in *resourcev1alpha1.ResourceClaimTemplateApplyConfiguration, opts metav1.ApplyOptions) (result *apiresourcev1alpha1.ResourceClaimTemplate, err error) {
	...
	out := &apiresourcev1alpha1.ResourceClaimTemplate{}
	if err := convert(uo, out); err != nil {
		return nil, err
	}
	return out, nil
...
func (w *wrapResourceV1alpha1ResourceClaimTemplateImpl) ApplyStatus(ctx context.Context, in *resourcev1alpha1.ResourceClaimTemplateApplyConfiguration, opts metav1.ApplyOptions) (result *apiresourcev1alpha1.ResourceClaimTemplate, err error) {
	in.Kind = ptr.String("ResourceClaimTemplate")
...
func (w *wrapResourceV1alpha1ResourceClaimTemplateImpl) Create(ctx context.Context, in *apiresourcev1alpha1.ResourceClaimTemplate, opts metav1.CreateOptions) (*apiresourcev1alpha1.ResourceClaimTemplate, error) {
	in.SetGroupVersionKind(schema.GroupVersionKind{
		Group:   "resource.k8s.io",
		Version: "v1alpha1",
...
func (w *wrapResourceV1alpha1ResourceClaimTemplateImpl) Delete(ctx context.Context, name string, opts metav1.DeleteOptions) error {
	return w.dyn.Namespace(w.namespace).Delete(ctx, name, opts)
}

func (w *wrapResourceV1alpha1ResourceClaimTemplateImpl) DeleteCollection(ctx context.Context, opts metav1.DeleteOptions, listOpts metav1.ListOptions) error {
	return w.dyn.Namespace(w.namespace).DeleteCollection(ctx, opts, listOpts)
}

func (w *wrapResourceV1alpha1ResourceClaimTemplateImpl) Get(ctx context.Context, name string, opts metav1.GetOptions) (*apiresourcev1alpha1.ResourceClaimTemplate, error) {
	uo, err := w.dyn.Namespace(w.namespace).Get(ctx, name, opts)
	if err != nil {
		return nil, err
	}
...
func (w *wrapResourceV1alpha1ResourceClaimTemplateImpl) List(ctx context.Context, opts metav1.ListOptions) (*apiresourcev1alpha1.ResourceClaimTemplateList, error) {
	uo, err := w.dyn.Namespace(w.namespace).List(ctx, opts)
	if err != nil {
		return nil, err
	}
	out := &apiresourcev1alpha1.ResourceClaimTemplateList{}
	if err := convert(uo, out); err != nil {
		return nil, err
	}
	return out, nil
...
func (w *wrapResourceV1alpha1ResourceClaimTemplateImpl) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts metav1.PatchOptions, subresources ...string) (result *apiresourcev1alpha1.ResourceClaimTemplate, err error) {
	uo, err := w.dyn.Namespace(w.namespace).Patch(ctx, name, pt, data, opts)
	if err != nil {
		return nil, err
	}
...
func (w *wrapResourceV1alpha1ResourceClaimTemplateImpl) Update(ctx context.Context, in *apiresourcev1alpha1.ResourceClaimTemplate, opts metav1.UpdateOptions) (*apiresourcev1alpha1.ResourceClaimTemplate, error) {
	in.SetGroupVersionKind(schema.GroupVersionKind{
		Group:   "resource.k8s.io",
		Version: "v1alpha1",
		Kind:    "ResourceClaimTemplate",
...
func (w *wrapResourceV1alpha1ResourceClaimTemplateImpl) UpdateStatus(ctx context.Context, in *apiresourcev1alpha1.ResourceClaimTemplate, opts metav1.UpdateOptions) (*apiresourcev1alpha1.ResourceClaimTemplate, error) {
	in.SetGroupVersionKind(schema.GroupVersionKind{
		Group:   "resource.k8s.io",
		Version: "v1alpha1",
		Kind:    "ResourceClaimTemplate",
...
func (w *wrapResourceV1alpha1ResourceClaimTemplateImpl) Watch(ctx context.Context, opts metav1.ListOptions) (watch.Interface, error) {
	return nil, errors.New("NYI: Watch")
}

func (w *wrapResourceV1alpha1) ResourceClasses() typedresourcev1alpha1.ResourceClassInterface {
	return &wrapResourceV1alpha1ResourceClassImpl{
		dyn: w.dyn.Resource(schema.GroupVersionResource{
			Group:    "resource.k8s.io",
			Version:  "v1alpha1",
...
type wrapResourceV1alpha1ResourceClassImpl struct {
	dyn dynamic.NamespaceableResourceInterface
}

var _ typedresourcev1alpha1.ResourceClassInterface = (*wrapResourceV1alpha1ResourceClassImpl)(nil)

func (w *wrapResourceV1alpha1ResourceClassImpl) Apply(ctx context.Context, in *resourcev1alpha1.ResourceClassApplyConfiguration, opts metav1.ApplyOptions) (result *apiresourcev1alpha1.ResourceClass, err error) {
	...
	out := &apiresourcev1alpha1.ResourceClass{}
	if err := convert(uo, out); err != nil {
		return nil, err
	}
	return out, nil
...
func (w *wrapResourceV1alpha1ResourceClassImpl) ApplyStatus(ctx context.Context, in *resourcev1alpha1.ResourceClassApplyConfiguration, opts metav1.ApplyOptions) (result *apiresourcev1alpha1.ResourceClass, err error) {
	in.Kind = ptr.String("ResourceClass")
...
func (w *wrapResourceV1alpha1ResourceClassImpl) Create(ctx context.Context, in *apiresourcev1alpha1.ResourceClass, opts metav1.CreateOptions) (*apiresourcev1alpha1.ResourceClass, error) {
	in.SetGroupVersionKind(schema.GroupVersionKind{
		Group:   "resource.k8s.io",
		Version: "v1alpha1",
		Kind:    "ResourceClass",
...
func (w *wrapResourceV1alpha1ResourceClassImpl) Delete(ctx context.Context, name string, opts metav1.DeleteOptions) error {
	return w.dyn.Delete(ctx, name, opts)
}

func (w *wrapResourceV1alpha1ResourceClassImpl) DeleteCollection(ctx context.Context, opts metav1.DeleteOptions, listOpts metav1.ListOptions) error {
	return w.dyn.DeleteCollection(ctx, opts, listOpts)
}

func (w *wrapResourceV1alpha1ResourceClassImpl) Get(ctx context.Context, name string, opts metav1.GetOptions) (*apiresourcev1alpha1.ResourceClass, error) {
	uo, err := w.dyn.Get(ctx, name, opts)
	if err != nil {
		return nil, err
	}
...
func (w *wrapResourceV1alpha1ResourceClassImpl) List(ctx context.Context, opts metav1.ListOptions) (*apiresourcev1alpha1.ResourceClassList, error) {
	uo, err := w.dyn.List(ctx, opts)
	if err != nil {
		return nil, err
	}
	out := &apiresourcev1alpha1.ResourceClassList{}
	if err := convert(uo, out); err != nil {
		return nil, err
	}
	return out, nil
...
func (w *wrapResourceV1alpha1ResourceClassImpl) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts metav1.PatchOptions, subresources ...string) (result *apiresourcev1alpha1.ResourceClass, err error) {
	uo, err := w.dyn.Patch(ctx, name, pt, data, opts)
	if err != nil {
		return nil, err
	}
...
func (w *wrapResourceV1alpha1ResourceClassImpl) Update(ctx context.Context, in *apiresourcev1alpha1.ResourceClass, opts metav1.UpdateOptions) (*apiresourcev1alpha1.ResourceClass, error) {
	in.SetGroupVersionKind(schema.GroupVersionKind{
		Group:   "resource.k8s.io",
		Version: "v1alpha1",
		Kind:    "ResourceClass",
...
func (w *wrapResourceV1alpha1ResourceClassImpl) UpdateStatus(ctx context.Context, in *apiresourcev1alpha1.ResourceClass, opts metav1.UpdateOptions) (*apiresourcev1alpha1.ResourceClass, error) {
	in.SetGroupVersionKind(schema.GroupVersionKind{
		Group:   "resource.k8s.io",
		Version: "v1alpha1",
		Kind:    "ResourceClass",
...
func (w *wrapResourceV1alpha1ResourceClassImpl) Watch(ctx context.Context, opts metav1.ListOptions) (watch.Interface, error) {
	return nil, errors.New("NYI: Watch")
}
