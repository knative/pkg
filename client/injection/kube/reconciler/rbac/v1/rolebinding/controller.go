...
const (
	defaultControllerAgentName = "rolebinding-controller"
	defaultFinalizerName       = "rolebindings.rbac.authorization.k8s.io"
	defaultQueueName           = "rolebindings"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	rec := &reconcilerImpl{
		...
		Lister:     rolebindingInformer.Lister(),
		Recorder:   recorder,
		reconciler: r,
	}
