...
func (r *reconcilerImpl) updateStatus(ctx context.Context, logger *zap.SugaredLogger, existing *v1beta1.NetworkPolicy, desired *v1beta1.NetworkPolicy) error {
	existing = existing.DeepCopy()
	return reconciler.RetryUpdateConflicts(func(attempts int) (err error) {
		// The first iteration tries to use the injectionInformer's state, subsequent attempts fetch the latest state via API.
		if attempts > 0 {

			getter := r.Client.ExtensionsV1beta1().NetworkPolicies(desired.Namespace)
		...
		updater := r.Client.ExtensionsV1beta1().NetworkPolicies(existing.Namespace)
...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1beta1.NetworkPolicy, desiredFinalizers sets.String) (*v1beta1.NetworkPolicy, error) {
	...
	updater := r.Client.ExtensionsV1beta1().NetworkPolicies(resource.Namespace)
