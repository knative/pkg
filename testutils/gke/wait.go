...
// WaitUtilDone depends on unique opName(operation ID created by cloud), and waits until it's done.
func (gsc *sdkClient) wait(project, location, opName string, waitTime time.Duration) error {
