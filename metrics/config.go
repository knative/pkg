...
func JsonToMetricsOptions(jsonOpts string) (*ExporterOptions, error) { // nolint:stylecheck // No rename due to backwards incompatibility.
...
func MetricsOptionsToJson(opts *ExporterOptions) (string, error) { // nolint:stylecheck // No rename due to backwards incompatibility.
	if opts == nil {
		return "", nil
	}
