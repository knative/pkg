...
// These tests create fake actual exporter services to verify that the metrics
// transmitted on the wire are correct. As such, we run them separately from
// the rest of the tests because of the duration and the nensitivity to
// external reconfiguration of the package-global metrics provider.
