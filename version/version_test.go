...
func TestVersionCheck(t *testing.T) {
	tests := []struct {
		...
		actualVersion: &testVersioner{version: "v1.22.1"},
	}, {
		name:          "greater version (patch), no v",
		actualVersion: &testVersioner{version: "1.22.1"},
	}, {
		name:          "greater version (patch), pre-release",
		actualVersion: &testVersioner{version: "1.22.1-kpn-065dce"},
	}, {
		name:          "greater version (patch), pre-release with build",
		actualVersion: &testVersioner{version: "1.22.1-1095+9689d22dc3121e-dirty"},
	}, {
		...
		actualVersion: &testVersioner{version: "v1.22.0+k3s.1"},
	}, {
